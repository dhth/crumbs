            ...
            match model.active_pane {
                ...
                _ => match key_event.code {
                    ...
                    KeyCode::Char('g') => match model.active_pane {
                        Pane::Sessions => Some(Msg::SelectFirstSession),
                        Pane::Crumbs => Some(Msg::ScrollCrumbsToTop),
                        _ => None,
                    },
                    KeyCode::Char('G') => match model.active_pane {
                        Pane::Sessions => Some(Msg::SelectLastSession),
                        Pane::Crumbs => Some(Msg::ScrollCrumbsToBottom),
                        _ => None,
                    },
